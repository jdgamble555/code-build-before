<script lang="ts">
	...
	import AddImageButton from './add-image-button.svelte';
...
<div class="custom-mark">
	<markdown-toolbar for="controlId" class="toolbar-mark">
		...
		<md-ref>
			<button class="btn">
				<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-tag" fill="currentColor">
					<path
						fill-rule="evenodd"
